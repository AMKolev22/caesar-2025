export default function Page() {
    return (
        <div className="w-screen h-screen flex flex-col items-center justify-center leading-wide tracking-wide">
            <h1 className="text-white text-xl font-semibold text-center">Sorry, you're not allowed to visit this page yet. Please ask an admin to approve your authentication request.</h1>
