          ...
          <div className="flex-1 rounded-xl bg-muted/50 p-4 md:h-auto max-h-[100vh] overflow-y-hidden">
            ...
            <ScrollArea className="h-full w-full">
              <div className="space-y-4 pr-2">
                ...
                <div key={request.id} className="border border-zinc-700 text-white px-4 py-3 rounded-md space-y-2">
                    ...
                    >
                        ...
                        <div className="font-medium">{request.item?.product?.name || 'Unknown Product'}</div>
                        
                        <div className="flex items-center gap-1 mt-1">
                            <span className="text-sm text-zinc-400">{request.item?.serialCode || 'N/A'}</span>
                    ...
                    <div className="flex items-center gap-6 text-sm text-zinc-300">
                        ...
                        <Badge 
                            variant="outline" 
                            className={`${getTypeColor(request.type)} border font-semibold mt-1`}
                        >
                        ...
                        <Badge 
                            variant="outline" 
                            className={`${getStatusColor(request.status)} border font-semibold mt-1`}
                        >
                            <div className="flex items-center gap-1">
                    ...
                    <div className="mt-4 border-t border-zinc-600 pt-4 space-y-4">
                        ...
                        <div>
                            <p className="text-sm text-gray-400 mb-1">Serial Code</p>
                            <p className="font-medium text-white">{request.item?.serialCode || 'N/A'}</p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-400 mb-1">Item Status</p>
                            <Badge 
                            variant="outline" 
                            className={`${request.item?.status === 'AVAILABLE' ? 'text-emerald-400 border-emerald-400/20' : 
                                        ...
                                        'text-yellow-400 border-yellow-400/20'} font-semibold`}
                            >
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-300">{request.item.product.location}</p>
                        </div>
                        )}

                        {request.item?.product?.description && (
                        <div>
                            <p className="text-sm text-gray-400 mb-1">Product Description</p>
                            <p className="text-sm text-gray-300">{request.item.product.description}</p>
                        </div>
                        )}
                        ...
                        <div className="flex gap-2 pt-4 border-t border-zinc-700">
                            ...
                            className="flex items-center gap-2 hover:bg-green-500/10 hover:border-green-500/50 hover:text-green-400"
                            >
                            ...
                            disabled={actionLoading.has(request.id)}
                            className="flex items-center gap-2 hover:bg-red-500/10 hover:border-red-500/50 hover:text-red-400"
                            >
                            ...
                            <div className="pt-4 border-t border-zinc-700">
                                <p className="text-sm text-gray-400 mb-2">Status History</p>
